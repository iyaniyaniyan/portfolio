  ...
  return (
    <article className="glass-card flex h-full flex-col overflow-hidden" data-reveal>
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <h3 className="mt-4 text-xl font-bold leading-7 text-slate-950">{project.title}</h3>
        <p className="mt-3 text-sm leading-7 text-slate-700">{project.shortDescription}</p>
